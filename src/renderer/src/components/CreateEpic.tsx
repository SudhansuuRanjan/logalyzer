...
const CreateEpic = ({ setShowCreateEpicModal, selectedEpicKey, onSuccess }: { setShowCreateEpicModal: (show: boolean) => void; selectedEpicKey: string | null; onSuccess?: () => void }) => {
            ...
            if (selectedEpicKey) {
                payloadToSend = {
                    ...
                    customFields: {
                        ...
                        customfield_10902: selectedEpicKey
                    }
                };
            }
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-lg border border-pink-100 transform animate-in zoom-in-95 duration-200">
                ...
                <form onSubmit={handleSubmit} className="space-y-6 bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div className="space-y-1">
                        ...
                        >
                            ...
                            {(selectedEpicKey ? ISSUE_TYPES.filter(t => t.label === "Story") : ISSUE_TYPES).map(t => (
