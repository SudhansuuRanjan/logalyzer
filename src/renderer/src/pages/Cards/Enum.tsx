...
alw-card:loc=${cardLoc}`;
  ...
  return (
    <div className="flex flex-col p-8 w-full max-w-full h-full overflow-y-auto">
      <h1 className="text-3xl font-bold text-pink-950 text-center">ENUM Card</h1>
      <p className="max-w-xl text-pink-900/60 text-center my-2 m-auto">
        Generate ENUM card commands by specifying the card location.
      </p>
      ...
      <form className="mt-5 space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          ...
          {inputField("IP Address C", ipAddressC, setIpAddressC, "ip_address_c")}
          {inputField("IP Address D", ipAddressD, setIpAddressD, "ip_address_d")}
          {inputField("Remote IP B", ipAddressRemoteB, setIpAddressRemoteB, "remote_ip_b")}
          {inputField("Remote IP C", ipAddressRemoteC, setIpAddressRemoteC, "remote_ip_c")}
        </div>
